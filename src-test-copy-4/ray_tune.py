...
def train_ray_rand(opt, checkpoint_dir=None, data_dir="../data_pred"):
...
def train_ray(opt, checkpoint_dir=None, data_dir="../data_pred"):
    device = torch.device("cuda" if torch.cuda.is_available() else "cpu")
    dataset = get_dataset(opt, data_dir, opt['not_lcc'])
...
def train_ray_int(opt, checkpoint_dir=None, data_dir="../data_pred"):
    device = torch.device("cuda" if torch.cuda.is_available() else "cpu")
    dataset = get_dataset(opt, data_dir, opt['not_lcc'])
