...
class Actor(InMemoryDataset):
  ...
  Args:
      ...
      transform (callable, optional): A function/transform that takes in an
          :obj:`torch_geometric.data_pred.Data` object and returns a transformed
          version. The data_pred object will be transformed before every access.
          (default: :obj:`None`)
      pre_transform (callable, optional): A function/transform that takes in
          an :obj:`torch_geometric.data_pred.Data` object and returns a
          transformed version. The data_pred object will be transformed before
...
class WikipediaNetwork(InMemoryDataset):
  ...
  Args:
      ...
      geom_gcn_preprocess (bool): If set to :obj:`True`, will load the
          pre-processed data_pred as introduced in the `"Geom-GCN: Geometric
